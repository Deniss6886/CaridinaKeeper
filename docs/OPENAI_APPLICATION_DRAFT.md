# Application draft (do not submit unchanged)
...
**What the project does:** CaridinaKeeper stores tank history, water observations with method and uncertainty, editable keeper targets, maintenance, breeding lines/events, reminders, and portable backups entirely in the browser. It has no mandatory account, telemetry, remote fonts, or automatic equipment control.
